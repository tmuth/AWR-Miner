...
define DATE_BEGIN = '2014-04-10'
define DATE_END   = '2014-04-20'
...
SELECT min(snap_id) - 1 snap_min1
  FROM dba_hist_snapshot
  WHERE dbid = &DBID 
    and begin_interval_time >= trunc(to_date('&DATE_BEGIN','YYYY-MM-DD'));
